...
local function CreateHealthPrediction(self)
  ...
  L.F.SetPoint(myBar, "TOP")
  L.F.SetPoint(myBar, "BOTTOM")
  L.F.SetPoint(myBar, "LEFT", self.Health:GetStatusBarTexture(), "RIGHT")
  myBar:SetWidth(200)
  myBar:SetStatusBarTexture(L.C.textures.statusbar)
  myBar:SetStatusBarColor(unpack(L.C.colors.healthbar.own))

  local otherBar = CreateFrame("StatusBar", nil, self.Health)
  L.F.SetPoint(otherBar, "TOP")
  L.F.SetPoint(otherBar, "BOTTOM")
  L.F.SetPoint(otherBar, "LEFT", self.Health:GetStatusBarTexture(), "RIGHT")
  ...
  L.F.SetPoint(absorbBar, "TOP")
  L.F.SetPoint(absorbBar, "BOTTOM")
  L.F.SetPoint(absorbBar, "LEFT", self.Health:GetStatusBarTexture(), "RIGHT")
  ...
  L.F.SetPoint(healAbsorbBar, "TOP")
  L.F.SetPoint(healAbsorbBar, "BOTTOM")
  L.F.SetPoint(healAbsorbBar, "LEFT", self.Health:GetStatusBarTexture())
  healAbsorbBar:SetWidth(200)
  healAbsorbBar:SetStatusBarTexture(L.C.textures.absorb)
  healAbsorbBar:SetReverseFill(true)

  local overAbsorb = self.Health:CreateTexture(nil, "OVERLAY")
  L.F.SetPoint(overAbsorb, "TOP")
  L.F.SetPoint(overAbsorb, "BOTTOM")
  L.F.SetPoint(overAbsorb, "LEFT", self.Health, "RIGHT")
  overAbsorb:SetWidth(10)

  local overHealAbsorb = self.Health:CreateTexture(nil, "OVERLAY")
  L.F.SetPoint(overHealAbsorb, "TOP")
  L.F.SetPoint(overHealAbsorb, "BOTTOM")
  L.F.SetPoint(overHealAbsorb, "LEFT", self.Health, "RIGHT")
